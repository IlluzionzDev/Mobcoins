...
public class CmdGiveCoins extends SubCommand {

    public CmdGiveCoins(){
        name = "give";
        permission = Permission.CMD_GIVE_BALANCE;
    }
    ...
    public void onCommand(CommandSender player, String[] args) {
        ...
        msg.sendMsg(player, String.format(Lang.COMMAND_GIVECOINS.getConfigValue(), p.getName(), amount));
